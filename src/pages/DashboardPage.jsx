    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
        ...
        <div className="bg-gradient-to-br from-cream-50 to-orange-50 p-4 sm:p-8 rounded-3xl border-2 border-cream-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          ...
          <h3 className="text-lg sm:text-2xl font-bold text-gray-900 mb-2">{formatCurrency(stats.totalRevenue)}</h3>
          <p className="text-sm sm:text-base text-gray-600">Total Revenue</p>
        </div>

        <div className="bg-gradient-to-br from-yellow-50 to-red-50 p-4 sm:p-8 rounded-3xl border-2 border-yellow-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-yellow-500 to-red-500 rounded-2xl flex items-center justify-center text-white mb-4 sm:mb-6 shadow-lg">
            <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{stats.pending}</h3>
          <p className="text-sm sm:text-base text-gray-600">Pending Orders</p>
        </div>
      </div>
